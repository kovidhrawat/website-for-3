...
Star.prototype.draw = function () {
    ...
    c.shadowColor = '#ffcccc'; // Light red shadow
    c.shadowBlur = 20;
    c.fill();
    c.closePath();
    c.restore();
...
MiniStar.prototype.draw = function () {
    ...
    c.beginPath();
    c.arc(this.x, this.y, this.radius, 0, Math.PI * 2, false);
    c.fillStyle = `rgba(255, 204, 204, ${this.opacity})`; // Light red with opacity
    c.shadowColor = '#ffcccc'; // Matching shadow color
    c.shadowBlur = 20;
    c.fill();
    c.closePath();
    c.restore();
...
backgroundGradient.addColorStop(0, '#ffb3b3'); // Light Red
backgroundGradient.addColorStop(1, '#ff6666'); // Deeper Red
...
function animate() {
    ...
    if(flag) creatMountainRange(1, canvas.height * 0.7, '#c9184a')
    if(flag) creatMountainRange(2, canvas.height * 0.6, '#a4133c')
    if(flag) creatMountainRange(3, canvas.height * 0.4, '#800f2f')
    c.fillStyle = '#669bbc'
